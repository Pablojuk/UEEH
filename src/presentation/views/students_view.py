...
class StudentsView(QWidget):
    def __init__(
        ...
        self.table.setHorizontalHeaderLabels(["Sel.", "ID", "Apellidos", "Nombres", "Identificación"])
    ...
    def load_students(self) -> None:
        ...
        for row_data in rows:
            ...
            self.table.setItem(row, 1, QTableWidgetItem(row_data.get("id_estudiante", "")))
    ...
    def delete_students(self) -> None:
        ...
        for row in range(self.table.rowCount()):
            ...
            if item and item.checkState() == Qt.Checked:
                selected_ids.append(self.table.item(row, 1).text())
